...
$jscomp.iteratorPrototype=function(a){$jscomp.initSymbolIterator();a={next:a};a[$jscomp.global.Symbol.iterator]=function(){return this};return a};$jscomp.makeIterator=function(a){$jscomp.initSymbolIterator();var b=a[Symbol.iterator];return b?b.call(a):$jscomp.arrayIterator(a)};$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,e){return c==a&&"q"==d&&e==b}}));return!0===b.q}catch(c){return!1}};
...
*/
goog.asserts={};goog.asserts.ENABLE_ASSERTS=goog.DEBUG;goog.asserts.assert=function(){};goog.asserts.patchAssert_=function(){var a=console.assert;a?a.bind||(console.assert=function(){a.apply(console,arguments)}):console.assert=function(){}};goog.asserts.ENABLE_ASSERTS&&(goog.asserts.patchAssert_(),goog.asserts.assert=console.assert.bind(console));function ShakaReceiver(){this.idleTimerId_=this.idle_=this.controlsTimerId_=this.controlsElement_=this.receiver_=this.player_=this.video_=null;this.idleTimeout_=300}
ShakaReceiver.prototype.init=function(){shaka.polyfill.installAll();var a=document.getElementById("video");goog.asserts.assert(a,"Video element should be available!");this.video_=a;a=this.video_.ui;goog.asserts.assert(a,"UI should be available!");a.configure({controlPanelElements:["play_pause","time_and_duration","spacer"]});this.player_=a.getPlayer();goog.asserts.assert(this.player_,"Player should be available!");this.controlsElement_=document.querySelector(".shaka-controls-container");this.idle_=
document.getElementById("idle");this.video_.addEventListener("play",this.onPlayStateChange_.bind(this));this.video_.addEventListener("pause",this.onPlayStateChange_.bind(this));this.video_.addEventListener("seeking",this.onPlayStateChange_.bind(this));this.video_.addEventListener("emptied",this.onPlayStateChange_.bind(this));this.receiver_=new shaka.cast.CastReceiver(this.video_,this.player_,this.appDataCallback_.bind(this));this.receiver_.addEventListener("caststatuschanged",this.checkIdle_.bind(this));
this.startIdleTimer_()};ShakaReceiver.prototype.appDataCallback_=function(a){a&&(a=ShakaDemoAssetInfo.fromJSON(a.asset),a.applyFilters(this.player_.getNetworkingEngine()),a=a.getConfiguration(),this.player_.configure(a))};
ShakaReceiver.prototype.checkIdle_=function(){console.debug("status changed","idle=",this.receiver_.isIdle());this.receiver_.isIdle()?(this.idle_.style.display="block",this.startIdleTimer_()):(this.idle_.style.display="none",this.cancelIdleTimer_(),0!=this.video_.readyState&&this.player_.isAudioOnly()?this.video_.poster="https://shaka-player-demo.appspot.com/assets/audioOnly.gif":this.video_.removeAttribute("poster"))};
...
"https://content.uplynk.com/wv").setRequestFilter(shakaAssets.UplynkRequestFilter).setResponseFilter(shakaAssets.UplynkResponseFilter)];var shaka={log:{}};shaka.log.Level={NONE:0,ERROR:1,WARNING:2,INFO:3,DEBUG:4,V1:5,V2:6};shaka.log.MAX_LOG_LEVEL=3;shaka.log.alwaysError=function(){};shaka.log.alwaysWarn=function(){};shaka.log.error=function(){};shaka.log.warning=function(){};shaka.log.info=function(){};shaka.log.debug=function(){};shaka.log.v1=function(){};shaka.log.v2=function(){};
...
//# sourceMappingURL=receiver.compiled.debug.map