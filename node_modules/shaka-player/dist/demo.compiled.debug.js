...
0;a<this.onSettledCallbacks_.length;++a)f.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var f=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(m){c.reject(m)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(r){g(r)}}:
...
d){for(var e=$jscomp.makeIterator(a),g=e.next();!g.done;g=e.next())c(g.value).callWhenSettled_(b,d)})};e.all=function(a){var b=$jscomp.makeIterator(a),d=b.next();return d.done?c([]):new e(function(a,e){function g(b){return function(c){f[b]=c;k--;0==k&&a(f)}}var f=[],k=0;do f.push(void 0),k++,c(d.value).callWhenSettled_(g(f.length-1),e),d=b.next();while(!d.done)})};return e},"es6","es3");
...
var AssetCard=function(a,b,c,d){this.card_=document.createElement("div");this.asset_=b;this.actions_=document.createElement("div");this.featureIconsContainer_=document.createElement("div");this.progressBar_=document.createElement("progress");this.remakeButtonsFn_=d;this.card_.classList.add("mdl-card-wide");this.card_.classList.add("mdl-card");this.card_.classList.add("mdl-shadow--2dp");this.card_.classList.add("asset-card");d=document.createElement("div");d.classList.add("mdl-card__title");this.card_.appendChild(d);
var e=document.createElement("h2");e.classList.add("mdl-card__title-text");e.textContent=b.shortName||b.name;d.appendChild(e);b.iconUri&&(d=document.createElement("img"),d.src=b.iconUri,d.alt="",this.card_.appendChild(d));b.description&&c&&(c=document.createElement("div"),c.classList.add("mdl-card__supporting-text"),c.textContent=b.description,this.card_.appendChild(c));this.card_.appendChild(this.featureIconsContainer_);this.addFeatureIcons_(b);this.actions_.classList.add("mdl-card__actions");this.actions_.classList.add("mdl-card--border");
this.card_.appendChild(this.actions_);this.remakeButtons();c=document.createElement("div");this.progressBar_.classList.add("hidden");this.progressBar_.setAttribute("max",1);this.progressBar_.setAttribute("value",b.storedProgress);c.appendChild(this.progressBar_);this.card_.appendChild(c);a.appendChild(this.card_)};
AssetCard.prototype.addFeatureIcon_=function(a,b){var c=document.createElement("div");c.classList.add("feature-icon");c.setAttribute("icon",a);this.featureIconsContainer_.appendChild(c);ShakaDemoTooltips.make(this.featureIconsContainer_,c,b)};
AssetCard.prototype.addFeatureIcons_=function(a){var b=shakaAssets.Feature,c=shakaAssets.KeySystem;b=(new Map).set(b.SUBTITLES,"subtitles").set(b.CAPTIONS,"closed_caption").set(b.LIVE,"live").set(b.TRICK_MODE,"trick_mode").set(b.HIGH_DEFINITION,"high_definition").set(b.ULTRA_HIGH_DEFINITION,"ultra_high_definition").set(b.SURROUND,"surround_sound").set(b.MULTIPLE_LANGUAGES,"multiple_languages").set(b.AUDIO_ONLY,"audio_only");for(var d=$jscomp.makeIterator(a.features),e=d.next();!e.done;e=d.next()){e=
e.value;var f=b.get(e);f&&this.addFeatureIcon_(f,e)}a=$jscomp.makeIterator(a.drm);for(b=a.next();!b.done;b=a.next())switch(b.value){case c.WIDEVINE:this.addFeatureIcon_("widevine","Widevine DRM");break;case c.CLEAR_KEY:this.addFeatureIcon_("clear_key","Clear Key DRM");break;case c.PLAYREADY:this.addFeatureIcon_("playready","PlayReady DRM")}};AssetCard.prototype.markAsUnsupported=function(a){this.card_.classList.add("asset-card-unsupported");this.makeUnsupportedButton_("Not Available",a)};
AssetCard.prototype.makeUnsupportedButton_=function(a,b){var c=this.addButton(a,function(){});c.setAttribute("disabled","");var d=this.card_.parentElement;if(d&&b){var e=document.createElement("div");c.parentElement&&c.parentElement.removeChild(c);e.classList.add("tooltip-attach-point");e.appendChild(c);this.actions_.appendChild(e);ShakaDemoTooltips.make(d,e,b)}};AssetCard.prototype.selectByAsset=function(a){this.card_.classList.remove("selected");this.asset_==a&&this.card_.classList.add("selected")};
AssetCard.prototype.remakeButtons=function(){shaka.ui.Utils.removeAllChildren(this.actions_);this.remakeButtonsFn_(this)};
AssetCard.prototype.addStoreButton=function(){var a=this,b=shakaDemoMain.getAssetUnsupportedReason(this.asset_,!0);if(b||!this.asset_.storeCallback)this.makeUnsupportedButton_("Download",b);else if(this.asset_.isStored())var c=this.addButton("Delete",function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function f(){return $jscomp.generator.createGenerator(f,function(b){switch(b.nextAddress){case 1:return c.disabled=!0,b.yield(a.asset_.unstoreCallback(),2);case 2:a.remakeButtons(),b.jumpToEnd()}})})});
else var d=this.addButton("Download",function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function f(){return $jscomp.generator.createGenerator(f,function(b){switch(b.nextAddress){case 1:return d.disabled=!0,b.yield(a.asset_.storeCallback(),2);case 2:a.remakeButtons(),b.jumpToEnd()}})})})};
AssetCard.prototype.updateProgress=function(){if(1>this.asset_.storedProgress){this.progressBar_.classList.remove("hidden");for(var a=$jscomp.makeIterator(this.actions_.childNodes),b=a.next();!b.done;b=a.next())b.value.disabled=!0}else for(this.progressBar_.classList.add("hidden"),a=$jscomp.makeIterator(this.actions_.childNodes),b=a.next();!b.done;b=a.next())b.value.disabled=!1;this.progressBar_.setAttribute("value",this.asset_.storedProgress)};
AssetCard.prototype.addButton=function(a,b){var c=document.createElement("button");c.classList.add("mdl-button");c.classList.add("mdl-button--colored");c.classList.add("mdl-js-button");c.classList.add("mdl-js-ripple-effect");c.textContent=a;c.addEventListener("click",function(){c.hasAttribute("disabled")||b()});this.actions_.appendChild(c);return c};var CloseButton=function(a,b){this.parent=a;this.button_=document.createElement("button");this.button_.classList.add("material-icons");this.button_.classList.add("close-button");this.button_.textContent="close";this.parent.appendChild(this.button_);this.button_.addEventListener("click",function(){document.fullscreenElement&&document.exitFullscreen();document.pictureInPictureElement&&document.exitPictureInPicture();shakaDemoMain.unload()})};CloseButton.prototype.destroy=function(){return Promise.resolve()};
CloseButton.Factory=function(){};CloseButton.Factory.prototype.create=function(a,b){return new CloseButton(a,b)};var COMPILED=!0,goog=goog||{};goog.global=this;goog.isDef=function(a){return void 0!==a};goog.exportPath_=function(a,b,c){a=a.split(".");c=c||goog.global;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&goog.isDef(b)?c[d]=b:c=c[d]?c[d]:c[d]={}};
...
ShakaDemoAssetInfo.prototype.addFeature=function(a){goog.asserts.assert(a!=shakaAssets.Feature.STORED,'Assets should not be given the synthetic "STORED" property!');this.features.push(a);this.features.sort(ShakaDemoAssetInfo.caseLessAlphaComparator_);return this};ShakaDemoAssetInfo.prototype.addKeySystem=function(a){1==this.drm.length&&this.drm[0]==shakaAssets.KeySystem.CLEAR&&(this.drm=[]);this.drm.push(a);this.drm.sort(ShakaDemoAssetInfo.caseLessAlphaComparator_);return this};
ShakaDemoAssetInfo.prototype.setExtraConfig=function(a){this.extraConfig=a;return this};ShakaDemoAssetInfo.prototype.setRequestFilter=function(a){this.requestFilter=a;return this};ShakaDemoAssetInfo.prototype.setResponseFilter=function(a){this.responseFilter=a;return this};ShakaDemoAssetInfo.prototype.addLicenseServer=function(a,b){this.licenseServers.set(a,b);return this};ShakaDemoAssetInfo.prototype.addLicenseRequestHeader=function(a,b){this.licenseRequestHeaders.set(a,b);return this};
...
HIGH_DEFINITION:"High definition",ULTRA_HIGH_DEFINITION:"Ultra-high definition",SURROUND:"Surround sound",DASH:"DASH",HLS:"HLS"},UplynkResponseFilter:function(a,b){a==shaka.net.NetworkingEngine.RequestType.MANIFEST&&(shakaAssets.uplynk_prefix=b.headers["x-uplynk-prefix"]?b.headers["x-uplynk-prefix"]:"")},UplynkRequestFilter:function(a,b){a==shaka.net.NetworkingEngine.RequestType.LICENSE&&(b.uris[0].includes("wv")&&shakaAssets.uplynk_prefix?b.uris[0]=shakaAssets.uplynk_prefix.concat("/wv"):b.uris[0].includes("ck")&&
shakaAssets.uplynk_prefix?b.uris[0]=shakaAssets.uplynk_prefix.concat("/ck"):b.uris[0].includes("pr")&&shakaAssets.uplynk_prefix&&(b.uris[0]=shakaAssets.uplynk_prefix.concat("/pr")))}};
...
(new ShakaDemoAssetInfo("Clear, Live DASH","https://storage.googleapis.com/shaka-asset-icons/axinom_test.png","https://akamai-axtest.akamaized.net/routes/lapd-v1-acceptance/www_c4/Manifest.mpd",shakaAssets.Source.AXINOM)).addFeature(shakaAssets.Feature.LIVE).addFeature(shakaAssets.Feature.MP4).addFeature(shakaAssets.Feature.DASH).addFeature(shakaAssets.Feature.MULTIPERIOD).addFeature(shakaAssets.Feature.HIGH_DEFINITION).addFeature(shakaAssets.Feature.WEBVTT),(new ShakaDemoAssetInfo("Clear, Live HLS",
"https://storage.googleapis.com/shaka-asset-icons/axinom_test.png","https://akamai-axtest.akamaized.net/routes/lapd-v1-acceptance/www_c4/Manifest.m3u8",shakaAssets.Source.AXINOM)).addFeature(shakaAssets.Feature.HLS).addFeature(shakaAssets.Feature.LIVE).addFeature(shakaAssets.Feature.MP4).addFeature(shakaAssets.Feature.HIGH_DEFINITION),(new ShakaDemoAssetInfo("Tears of Steel","https://storage.googleapis.com/shaka-asset-icons/tears_of_steel.png","https://demo.unified-streaming.com/video/tears-of-steel/tears-of-steel.ism/.mpd",
shakaAssets.Source.UNIFIED_STREAMING)).addFeature(shakaAssets.Feature.DASH).addFeature(shakaAssets.Feature.HIGH_DEFINITION).addFeature(shakaAssets.Feature.MP4).addFeature(shakaAssets.Feature.OFFLINE),(new ShakaDemoAssetInfo("Tears of Steel (Widevine)","https://storage.googleapis.com/shaka-asset-icons/tears_of_steel.png","https://demo.unified-streaming.com/video/tears-of-steel/tears-of-steel-dash-widevine.ism/.mpd",shakaAssets.Source.UNIFIED_STREAMING)).addKeySystem(shakaAssets.KeySystem.WIDEVINE).addFeature(shakaAssets.Feature.DASH).addFeature(shakaAssets.Feature.HIGH_DEFINITION).addFeature(shakaAssets.Feature.MP4).addFeature(shakaAssets.Feature.SUBTITLES).addFeature(shakaAssets.Feature.TTML).addLicenseServer("com.widevine.alpha",
...
"https://livesim.dashif.org/dash/vod/testpic_2s/img_subs.mpd",shakaAssets.Source.DASH_IF)).addFeature(shakaAssets.Feature.DASH).addFeature(shakaAssets.Feature.SUBTITLES).addFeature(shakaAssets.Feature.MP4).addFeature(shakaAssets.Feature.TTML),(new ShakaDemoAssetInfo("Big Buck Bunny (Live)","https://storage.googleapis.com/shaka-asset-icons/big_buck_bunny.png","https://wowzaec2demo.streamlock.net/live/bigbuckbunny/manifest_mpm4sav_mvtime.mpd",shakaAssets.Source.WOWZA)).addFeature(shakaAssets.Feature.DASH).addFeature(shakaAssets.Feature.LIVE).addFeature(shakaAssets.Feature.MP4),
(new ShakaDemoAssetInfo("Art of Motion (DASH)","https://storage.googleapis.com/shaka-asset-icons/art_of_motion.png","https://bitdash-a.akamaihd.net/content/MI201109210084_1/mpds/f08e80da-bf1d-4e3d-8899-f0f6155f6efa.mpd",shakaAssets.Source.BITCODIN)).addFeature(shakaAssets.Feature.DASH).addFeature(shakaAssets.Feature.HIGH_DEFINITION).addFeature(shakaAssets.Feature.MP4).addFeature(shakaAssets.Feature.OFFLINE),(new ShakaDemoAssetInfo("Art of Motion (HLS, TS)","https://storage.googleapis.com/shaka-asset-icons/art_of_motion.png",
"https://bitdash-a.akamaihd.net/content/MI201109210084_1/m3u8s/f08e80da-bf1d-4e3d-8899-f0f6155f6efa.m3u8",shakaAssets.Source.BITCODIN)).markAsDisabled().addFeature(shakaAssets.Feature.HIGH_DEFINITION).addFeature(shakaAssets.Feature.HLS).addFeature(shakaAssets.Feature.MP2TS).addFeature(shakaAssets.Feature.OFFLINE),(new ShakaDemoAssetInfo("Sintel (HLS, TS, 4k)","https://storage.googleapis.com/shaka-asset-icons/sintel.png","https://bitdash-a.akamaihd.net/content/sintel/hls/playlist.m3u8",shakaAssets.Source.BITCODIN)).markAsDisabled().addFeature(shakaAssets.Feature.HIGH_DEFINITION).addFeature(shakaAssets.Feature.HLS).addFeature(shakaAssets.Feature.MP2TS).addFeature(shakaAssets.Feature.OFFLINE),
(new ShakaDemoAssetInfo("Big Buck Bunny (Nimble)","https://storage.googleapis.com/shaka-asset-icons/big_buck_bunny.png","https://video.wmspanel.com/local/raw/BigBuckBunny_320x180.mp4/manifest.mpd",shakaAssets.Source.NIMBLE_STREAMER)).markAsDisabled().addFeature(shakaAssets.Feature.DASH).addFeature(shakaAssets.Feature.MP4).addFeature(shakaAssets.Feature.HIGH_DEFINITION),(new ShakaDemoAssetInfo("Azure Trailer","https://storage.googleapis.com/shaka-asset-icons/azure.png","https://amssamples.streaming.mediaservices.windows.net/91492735-c523-432b-ba01-faba6c2206a2/AzureMediaServicesPromo.ism/manifest(format=mpd-time-csf)",
...
"https://content.uplynk.com/pr").addLicenseServer("com.widevine.alpha","https://content.uplynk.com/wv").setRequestFilter(shakaAssets.UplynkRequestFilter).setResponseFilter(shakaAssets.UplynkResponseFilter),(new ShakaDemoAssetInfo("Widevine - 16 Byte IV","https://storage.googleapis.com/shaka-asset-icons/big_buck_bunny.png","https://content.uplynk.com/224ac8717e714b68831997ab6cea4015.mpd",shakaAssets.Source.UPLYNK)).markAsDisabled().addKeySystem(shakaAssets.KeySystem.WIDEVINE).addFeature(shakaAssets.Feature.DASH).addFeature(shakaAssets.Feature.MP4).addFeature(shakaAssets.Feature.MULTIKEY).addFeature(shakaAssets.Feature.AESCTR_16_BYTE_IV).addFeature(shakaAssets.Feature.HIGH_DEFINITION).addLicenseServer("com.widevine.alpha",
"https://content.uplynk.com/wv").setRequestFilter(shakaAssets.UplynkRequestFilter).setResponseFilter(shakaAssets.UplynkResponseFilter),(new ShakaDemoAssetInfo("Widevine - 16 Byte IV - (mix of encrypted and unencrypted periods)","https://storage.googleapis.com/shaka-asset-icons/sintel.png","https://content.uplynk.com/1eb40d8e64234f5c9879db7045c3d48c.mpd?ad=cleardash&rays=cdefg",shakaAssets.Source.UPLYNK)).markAsDisabled().addKeySystem(shakaAssets.KeySystem.WIDEVINE).addFeature(shakaAssets.Feature.DASH).addFeature(shakaAssets.Feature.MP4).addFeature(shakaAssets.Feature.MULTIPLE_LANGUAGES).addFeature(shakaAssets.Feature.MULTIPERIOD).addFeature(shakaAssets.Feature.MULTIKEY).addFeature(shakaAssets.Feature.HIGH_DEFINITION).addFeature(shakaAssets.Feature.AESCTR_16_BYTE_IV).addFeature(shakaAssets.Feature.ENCRYPTED_WITH_CLEAR).addLicenseServer("com.widevine.alpha",
"https://content.uplynk.com/wv").setRequestFilter(shakaAssets.UplynkRequestFilter).setResponseFilter(shakaAssets.UplynkResponseFilter)];var shakaDemoConfig,ShakaDemoConfig=function(a){var b=this;this.container_=a;this.sections_=[];this.latestInput_=null;this.addedFields_=new Set;this.reload_();document.addEventListener("shaka-main-config-change",function(){b.reloadAndSaveState_()});document.addEventListener("shaka-main-drawer-state-change",function(){b.setContentAvailability_(shakaDemoMain.getIsDrawerOpen())});this.setContentAvailability_(shakaDemoMain.getIsDrawerOpen())};
ShakaDemoConfig.init=function(){var a=shakaDemoMain.getHamburgerMenu();shakaDemoConfig=new ShakaDemoConfig(a)};ShakaDemoConfig.prototype.setContentAvailability_=function(a){a?this.container_.classList.remove("hidden"):this.container_.classList.add("hidden")};
ShakaDemoConfig.prototype.reload_=function(){shaka.ui.Utils.removeAllChildren(this.container_);this.sections_=[];this.addMetaSection_();this.addLanguageSection_();this.addAbrSection_();this.addDrmSection_();this.addStreamingSection_();this.addManifestSection_();this.addRetrictionsSection_("","");this.checkSectionCompleteness_();this.checkSectionValidity_()};
ShakaDemoConfig.prototype.reloadAndSaveState_=function(){var a=this.sections_.map(function(a){return a.getIsOpen()});this.reload_();for(var b=0;b<a.length;b++){var c=this.sections_[b];a[b]&&c.open()}componentHandler.upgradeDom()};
ShakaDemoConfig.prototype.addDrmSection_=function(){var a=this,b=this.resolveExternLink_(".DrmConfiguration");this.addSection_("DRM",b).addBoolInput_("Delay License Request Until Played","drm.delayLicenseRequestUntilPlayed");var c=shakaDemoMain.getConfiguration().drm.advanced,d=["SW_SECURE_CRYPTO","SW_SECURE_DECODE","HW_SECURE_CRYPTO","HW_SECURE_DECODE","HW_SECURE_ALL"],e=["com.widevine.alpha","com.microsoft.playready","com.apple.fps.1_0","com.adobe.primetime","org.w3.clearkey"];b=function(b,g){a.addDatalistInput_(b,
d,function(a){for(var b=$jscomp.makeIterator(e),d=b.next();!d.done;d=b.next())d.value in c||(c[e]={});for(var f in c)c[f][g]=a.value;shakaDemoMain.configure("drm.advanced",c);shakaDemoMain.remakeHash()});var f=Object.keys(c)[0];f&&(f=c[f][g],a.latestInput_.input().value=f)};b("Video Robustness","videoRobustness");b("Audio Robustness","audioRobustness");this.addRetrySection_("drm","DRM")};
ShakaDemoConfig.prototype.addManifestSection_=function(){var a=this.resolveExternLink_(".ManifestConfiguration");this.addSection_("Manifest",a).addBoolInput_("Ignore DASH DRM Info","manifest.dash.ignoreDrmInfo").addBoolInput_("Xlink Should Fail Gracefully","manifest.dash.xlinkFailGracefully").addNumberInput_("Availability Window Override","manifest.availabilityWindowOverride",!0,!1,!0).addTextInput_("Clock Sync URI","manifest.dash.clockSyncUri").addBoolInput_("Ignore DRM Info","manifest.dash.ignoreDrmInfo").addNumberInput_("Default Presentation Delay",
"manifest.dash.defaultPresentationDelay").addBoolInput_("Ignore Min Buffer Time","manifest.dash.ignoreMinBufferTime");this.addRetrySection_("manifest","Manifest")};
ShakaDemoConfig.prototype.addAbrSection_=function(){var a=this.resolveExternLink_(".AbrConfiguration");this.addSection_("Adaptation",a).addBoolInput_("Enabled","abr.enabled").addNumberInput_("Default Bandwidth Estimate","abr.defaultBandwidthEstimate").addNumberInput_("Bandwidth Downgrade Target","abr.bandwidthDowngradeTarget",!0).addNumberInput_("Bandwidth Upgrade Target","abr.bandwidthUpgradeTarget",!0).addNumberInput_("Switch Interval","abr.switchInterval",!0);this.addRetrictionsSection_("abr",
"Adaptation")};
ShakaDemoConfig.prototype.addRetrictionsSection_=function(a,b){var c=(a?a+".":"")+"restrictions.",d=(b?b+" ":"")+"Restrictions",e=this.resolveExternLink_(".Restrictions");this.addSection_(d,e).addNumberInput_("Min Width",c+"minWidth").addNumberInput_("Max Width",c+"maxWidth").addNumberInput_("Min Height",c+"minHeight").addNumberInput_("Max Height",c+"maxHeight").addNumberInput_("Min Pixels",c+"minPixels").addNumberInput_("Max Pixels",c+"maxPixels").addNumberInput_("Min Bandwidth",c+"minBandwidth").addNumberInput_("Max Bandwidth",
c+"maxBandwidth")};ShakaDemoConfig.prototype.addRetrySection_=function(a,b){var c=a+".retryParameters.",d=this.resolveExternLink_(".RetryParameters");this.addSection_(b+" Retry Parameters",d).addNumberInput_("Max Attempts",c+"maxAttempts").addNumberInput_("Base Delay",c+"baseDelay",!0).addNumberInput_("Backoff Factor",c+"backoffFactor",!0).addNumberInput_("Fuzz Factor",c+"fuzzFactor",!0).addNumberInput_("Timeout",c+"timeout",!0)};
ShakaDemoConfig.prototype.addStreamingSection_=function(){var a=this.resolveExternLink_(".StreamingConfiguration");this.addSection_("Streaming",a).addNumberInput_("Maximum Small Gap Size","streaming.smallGapLimit",!0).addNumberInput_("Buffering Goal","streaming.bufferingGoal",!0).addNumberInput_("Duration Backoff","streaming.durationBackoff",!0).addNumberInput_("Rebuffering Goal","streaming.rebufferingGoal",!0).addNumberInput_("Buffer Behind","streaming.bufferBehind",!0);shakaDemoMain.getNativeControlsEnabled()?
(this.addCustomBoolInput_("Always Stream Text",function(a){},"Text must always be streamed while native controls are enabled, for captions to work."),this.latestInput_.input().disabled=!0,this.latestInput_.input().checked=!0):this.addBoolInput_("Always Stream Text","streaming.alwaysStreamText");this.addBoolInput_("Jump Large Gaps","streaming.jumpLargeGaps").addBoolInput_("Force Transmux TS","streaming.forceTransmuxTS").addBoolInput_("Start At Segment Boundary","streaming.startAtSegmentBoundary").addBoolInput_("Ignore Text Stream Failures",
"streaming.ignoreTextStreamFailures");this.addRetrySection_("streaming","Streaming")};
ShakaDemoConfig.prototype.addLanguageSection_=function(){var a=this.resolveExternLink_(".PlayerConfiguration");this.addSection_("Language",a).addTextInput_("Preferred Audio Language","preferredAudioLanguage").addTextInput_("Preferred Text Language","preferredTextLanguage");this.addCustomTextInput_("Preferred UI Locale",function(a){shakaDemoMain.setUILocale(a.value)});this.latestInput_.input().value=shakaDemoMain.getUILocale();this.addNumberInput_("Preferred Audio Channel Count","preferredAudioChannelCount")};
ShakaDemoConfig.prototype.addMetaSection_=function(){var a=this;this.addSection_("",null);this.addCustomBoolInput_("Shaka Controls",function(b){shakaDemoMain.setNativeControlsEnabled(!b.checked);b.checked&&(shakaDemoMain.configure("streaming.alwaysStreamText",!0),shakaDemoMain.remakeHash());a.reloadAndSaveState_()});shakaDemoMain.getNativeControlsEnabled()||(this.latestInput_.input().checked=!0);if(shaka.log){var b=shaka.log.Level,c=shaka.log.setLevel;this.addSelectInput_("Log Level",{info:"Info",
debug:"Debug",v:"Verbose",vv:"Very Verbose"},function(a){switch(a.value){case "info":c(b.INFO);break;case "debug":c(b.DEBUG);break;case "vv":c(b.V2);break;case "v":c(b.V1)}shakaDemoMain.remakeHash()});var d=this.latestInput_.input();switch(shaka.log.currentLevel){case b.DEBUG:d.value="debug";break;case b.V2:d.value="vv";break;case b.V1:d.value="v";break;default:d.value="info"}}};ShakaDemoConfig.prototype.resolveExternLink_=function(a){return"../docs/api/shakaExtern.html#"+a};
ShakaDemoConfig.prototype.addSection_=function(a,b){this.sections_.push(new ShakaDemoInputContainer(this.container_,a,a?ShakaDemoInputContainer.Style.ACCORDION:ShakaDemoInputContainer.Style.VERTICAL,b));return this};ShakaDemoConfig.prototype.addBoolInput_=function(a,b,c){this.addCustomBoolInput_(a,function(a){shakaDemoMain.configure(b,a.checked);shakaDemoMain.remakeHash()},c);shakaDemoMain.getCurrentConfigValue(b)&&(this.latestInput_.input().checked=!0);this.addedFields_.add(b);return this};
ShakaDemoConfig.prototype.addCustomBoolInput_=function(a,b,c){this.createRow_(a,c);this.latestInput_=new ShakaDemoBoolInput(this.getLatestSection_(),a,b);return this};ShakaDemoConfig.prototype.addTextInput_=function(a,b,c){this.addCustomTextInput_(a,function(a){shakaDemoMain.configure(b,a.value);shakaDemoMain.remakeHash()},c);this.latestInput_.input().value=shakaDemoMain.getCurrentConfigValue(b);this.addedFields_.add(b);return this};
ShakaDemoConfig.prototype.addCustomTextInput_=function(a,b,c){this.createRow_(a,c);this.latestInput_=new ShakaDemoTextInput(this.getLatestSection_(),a,b);return this};
ShakaDemoConfig.prototype.addNumberInput_=function(a,b,c,d,e,f){c=void 0===c?!1:c;d=void 0===d?!0:d;e=void 0===e?!1:e;this.createRow_(a,f);this.latestInput_=new ShakaDemoNumberInput(this.getLatestSection_(),a,function(a){shakaDemoMain.resetConfiguration(b);shakaDemoMain.remakeHash();"Infinity"==a.value?(shakaDemoMain.configure(b,Infinity),shakaDemoMain.remakeHash()):""==a.value&&e||(a=Number(a.value),0==a&&!d||isNaN(a)||Math.floor(a)!=a&&!c||(shakaDemoMain.configure(b,a),shakaDemoMain.remakeHash()))},
c,d,e);this.latestInput_.input().value=shakaDemoMain.getCurrentConfigValue(b);isNaN(Number(this.latestInput_.input().value))&&e&&(this.latestInput_.input().value="");this.addedFields_.add(b);return this};ShakaDemoConfig.prototype.addDatalistInput_=function(a,b,c,d){this.createRow_(a,d);this.latestInput_=new ShakaDemoDatalistInput(this.getLatestSection_(),a,c,b);return this};
ShakaDemoConfig.prototype.addSelectInput_=function(a,b,c,d){this.createRow_(a,d);this.latestInput_=new ShakaDemoSelectInput(this.getLatestSection_(),a,c,b);return this};ShakaDemoConfig.prototype.createRow_=function(a,b){this.getLatestSection_().addRow(a,b||null)};
ShakaDemoConfig.prototype.checkSectionCompleteness_=function(){var a=this,b=new Set(["number","string","boolean"]),c=function(d,e){for(var f in d){var g=e?e+"."+f:f,h=d[f];b.has(typeof h)?a.addedFields_.has(g)||console.warn("WARNING: Does not have config field for "+g):c(h,g)}};c(shakaDemoMain.getConfiguration(),"")};
ShakaDemoConfig.prototype.checkSectionValidity_=function(){for(var a=$jscomp.makeIterator(this.addedFields_),b=a.next();!b.done;b=a.next())b=b.value,void 0==shakaDemoMain.getCurrentConfigValue(b)&&console.warn("WARNING: Invalid config field "+b)};ShakaDemoConfig.prototype.getLatestSection_=function(){goog.asserts.assert(0<this.sections_.length,"Must have at least one section.");return this.sections_[this.sections_.length-1]};document.addEventListener("shaka-main-loaded",ShakaDemoConfig.init);var shakaDemoCustom,ShakaDemoCustom=function(a){var b=this;this.dialog_=document.createElement("dialog");this.dialog_.classList.add("mdl-dialog");a.appendChild(this.dialog_);this.dialog_.showModal||dialogPolyfill.registerDialog(this.dialog_);this.assets_=this.loadAssetInfos_();this.assetCards_=[];this.savedList_=document.createElement("div");a.appendChild(this.savedList_);this.remakeSavedList_();var c=document.createElement("div");c.classList.add("add-button-container");a.appendChild(c);a=this.makeButton_("add",
!0,function(){b.showAssetDialog_(ShakaDemoAssetInfo.makeBlankAsset())});c.appendChild(a);document.addEventListener("shaka-main-selected-asset-changed",function(){b.updateSelected_()});document.addEventListener("shaka-main-offline-progress",function(){b.updateOfflineProgress_()})};ShakaDemoCustom.init=function(){var a=shakaDemoMain.addNavButton("custom");shakaDemoCustom=new ShakaDemoCustom(a)};ShakaDemoCustom.prototype.assets=function(){return Array.from(this.assets_)};
ShakaDemoCustom.prototype.updateOfflineProgress_=function(){for(var a=$jscomp.makeIterator(this.assetCards_),b=a.next();!b.done;b=a.next())b.value.updateProgress()};
ShakaDemoCustom.prototype.showAssetDialog_=function(a){var b=this;shaka.ui.Utils.removeAllChildren(this.dialog_);var c=document.createElement("div");this.dialog_.appendChild(c);var d=document.createElement("div");this.dialog_.appendChild(d);var e=[],f=new Set(["com.widevine.alpha","com.microsoft.playready","com.adobe.primetime","org.w3.clearkey"]),g,h,k=function(){var b=g.value,c=h.value;if(b){a.licenseServers.clear();for(var d=$jscomp.makeIterator(f.values()),e=d.next();!e.done;e=d.next())a.licenseServers.set(e.value,
b);c&&a.licenseServers.set(c,b)}else a.licenseServers.clear()},m=new ShakaDemoInputContainer(c,null,ShakaDemoInputContainer.Style.VERTICAL,null),l=function(a,b,c){m.addRow(null,null);c=new ShakaDemoTextInput(m,a,c);c.extra().textContent=a;b(c.input(),c.container())};l("Manifest URL",function(b,c){b.value=a.manifestUri;e.push(b);var d=document.createElement("span");d.classList.add("mdl-textfield__error");d.textContent="Must have a manifest URL.";c.appendChild(d);b.required=!0;b.pattern="^(?!([\r\n\t\f\v ]+)$).*$"},
function(b){a.manifestUri=b.value});l("Custom License Server URL",function(b,c){g=b;var d=a.licenseServers.keys().next();d&&d.value&&(b.value=a.licenseServers.get(d.value))},function(a){k()});l("Custom License Certificate URL",function(b,c){a.certificateUri&&(b.value=a.certificateUri)},function(b){a.certificateUri=b.value});l("Custom DRM System",function(b,c){h=b;var d=a.licenseServers.keys();d=$jscomp.makeIterator(d);for(var e=d.next();!e.done;e=d.next())if(e=e.value,!f.has(e)){b.value=e;break}},
function(a){k()});l("Name",function(c,d){c.value=a.name;e.push(c);var f=document.createElement("span");f.classList.add("mdl-textfield__error");f.textContent="Must be a unique alphanumeric name.";d.appendChild(f);c.required=!0;c.pattern="^(?!( *";f=$jscomp.makeIterator(b.assets_);for(var g=f.next();!g.done;g=f.next())g=g.value,g!=a&&(c.pattern+="|"+g.name);c.pattern+=")$)[a-zA-Z0-9 ]*$"},function(b){a.name=b.value});l("Icon URL",function(b,c){if(a.iconUri){b.value=a.iconUri;var e=document.createElement("img");
e.src=b.value;e.alt="";d.appendChild(e)}},function(b){shaka.ui.Utils.removeAllChildren(d);if(a.iconUri=b.value){var c=document.createElement("img");c.src=b.value;c.alt="";d.appendChild(c)}});l=document.createElement("tr");c.appendChild(l);l.appendChild(this.makeButton_("Save",!1,function(){for(var c=$jscomp.makeIterator(e),d=c.next();!d.done;d=c.next())if(!d.value.validity.valid)return;shakaDemoMain.setupOfflineSupport(a);b.assets_.add(a);b.saveAssetInfos_(b.assets_);b.remakeSavedList_();b.dialog_.close()}));
l.appendChild(this.makeButton_("Cancel",!1,function(){b.dialog_.close()}));componentHandler.upgradeDom();this.dialog_.showModal()};ShakaDemoCustom.prototype.loadAssetInfos_=function(){var a=window.localStorage.getItem(ShakaDemoCustom.saveId_);return a?(a=JSON.parse(a),new Set(a.map(function(a){a=ShakaDemoAssetInfo.fromJSON(a);shakaDemoMain.setupOfflineSupport(a);return a}))):new Set};
ShakaDemoCustom.prototype.saveAssetInfos_=function(a){var b=ShakaDemoCustom.saveId_;a=Array.from(a);window.localStorage.setItem(b,JSON.stringify(a))};
ShakaDemoCustom.prototype.makeButton_=function(a,b,c){var d=document.createElement("button");b?(d.classList.add("mdl-button--fab"),d.classList.add("mdl-button--colored"),b=document.createElement("i"),b.classList.add("material-icons"),b.textContent=a,d.appendChild(b)):(d.textContent=a,d.classList.add("mdl-button--raised"));d.addEventListener("click",c);d.classList.add("mdl-button");d.classList.add("mdl-js-button");d.classList.add("mdl-js-ripple-effect");return d};
ShakaDemoCustom.prototype.createAssetCardFor_=function(a){var b=this;return new AssetCard(this.savedList_,a,!1,function(c){c.addButton("Play",function(){shakaDemoMain.loadAsset(a);b.updateSelected_()});c.addButton("Edit",function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function e(){return $jscomp.generator.createGenerator(e,function(c){switch(c.nextAddress){case 1:if(!a.unstoreCallback){c.jumpTo(2);break}return c.yield(a.unstoreCallback(),2);case 2:b.showAssetDialog_(a),c.jumpToEnd()}})})});
c.addButton("Discard",function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function e(){return $jscomp.generator.createGenerator(e,function(c){switch(c.nextAddress){case 1:b.assets_["delete"](a);if(!a.unstoreCallback){c.jumpTo(2);break}return c.yield(a.unstoreCallback(),2);case 2:b.saveAssetInfos_(b.assets_),b.remakeSavedList_(),c.jumpToEnd()}})})});c.addStoreButton()})};
ShakaDemoCustom.prototype.updateSelected_=function(){for(var a=$jscomp.makeIterator(this.assetCards_),b=a.next();!b.done;b=a.next())b.value.selectByAsset(shakaDemoMain.selectedAsset)};
ShakaDemoCustom.prototype.remakeSavedList_=function(){var a=this;shaka.ui.Utils.removeAllChildren(this.savedList_);if(0==this.assets_.size){var b=function(b,d){var c=document.createElement("h2");c.classList.add("mdl-typography--"+b);c.textContent=d;a.savedList_.appendChild(c)};b("title","Try Shaka Player with your own content!");b("body-2","Press the button below to add a custom asset.");b("body-1","Custom assets will remain even after reloading the page.")}else this.assetCards_=Array.from(this.assets_).map(function(b){return a.createAssetCardFor_(b)}),
this.updateSelected_()};ShakaDemoCustom.saveId_="shakaPlayerDemoSavedAssets";document.addEventListener("shaka-main-loaded",ShakaDemoCustom.init);var ShakaDemoUtils={runThroughHashParams:function(a,b){var c=[],d=function(b,d){c.push(d);a(b,d)};d("audiolang","preferredAudioLanguage");d("textlang","preferredTextLanguage");d("channels","preferredAudioChannelCount");c.push("abr.enabled");c.push("streaming.jumpLargeGaps");c.push("drm.advanced");c.push("drm.servers");var e=[],f=[],g=function(a){for(var b in a){e.includes(b)&&!f.includes(b)&&f.push(b);e.push(b);var c=a[b];"number"!=typeof c&&"string"!=typeof c&&"boolean"!=typeof c&&g(c)}};g(b);var h=
function(b,d){for(var e in b){var g=e,k=d+e;if(!c.includes(k)){f.includes(e)&&(g=k);var m=b[e];"number"==typeof m||"string"==typeof m||"boolean"==typeof m?a(g,k):h(m,k+".")}}};h(b,"")},browserSupportsUncompiledMode:function(){try{return eval("async ()=>{}"),!0}catch(a){return!1}}};var shakaDemoFront,ShakaDemoFront=function(a){var b=this;this.assetCards_=[];this.messageDiv_=document.createElement("div");this.assetCardDiv_=document.createElement("div");a.appendChild(this.messageDiv_);this.makeMessage_();a.appendChild(this.assetCardDiv_);this.remakeAssetCards_();document.addEventListener("shaka-main-selected-asset-changed",function(){b.updateSelected_()});document.addEventListener("shaka-main-offline-progress",function(){b.updateOfflineProgress_()})};
ShakaDemoFront.init=function(){var a=shakaDemoMain.addNavButton("front");shakaDemoFront=new ShakaDemoFront(a)};
ShakaDemoFront.prototype.makeMessage_=function(){var a=this;if(!window.localStorage.getItem("shakaPlayerHideFrontMessage")){var b=function(b,d){var c=document.createElement("h2");c.classList.add("mdl-typography--"+b);c.textContent=d;a.messageDiv_.appendChild(c)};b("body-2","This is a demo of Google's Shaka Player, a JavaScript library for adaptive video streaming.");b("body-1","Choose a video to playback; more assets are available via the search tab.");b=document.createElement("button");b.classList.add("mdl-button");
...
ShakaDemoFront.prototype.remakeAssetCards_=function(){var a=this;shaka.ui.Utils.removeAllChildren(this.assetCardDiv_);this.assetCards_=shakaAssets.testAssets.filter(function(a){return a.isFeatured&&!a.disabled}).map(function(b){return a.createAssetCardFor_(b,a.assetCardDiv_)})};
ShakaDemoFront.prototype.createAssetCardFor_=function(a,b){var c=this;return new AssetCard(b,a,!0,function(b){var d=shakaDemoMain.getAssetUnsupportedReason(a,!1);d?b.markAsUnsupported(d):(b.addButton("Play",function(){shakaDemoMain.loadAsset(a);c.updateSelected_()}),b.addStoreButton())})};ShakaDemoFront.prototype.updateOfflineProgress_=function(){for(var a=$jscomp.makeIterator(this.assetCards_),b=a.next();!b.done;b=a.next())b.value.updateProgress()};
ShakaDemoFront.prototype.updateSelected_=function(){for(var a=$jscomp.makeIterator(this.assetCards_),b=a.next();!b.done;b=a.next())b.value.selectByAsset(shakaDemoMain.selectedAsset)};document.addEventListener("shaka-main-loaded",ShakaDemoFront.init);var ShakaDemoInput=function(a,b,c,d,e){var f=this;this.container_=document.createElement(c);a.latestElementContainer.appendChild(this.container_);this.input_=document.createElement(b);this.input_.onchange=function(){e(f.input_)};this.input_.id=ShakaDemoInput.generateNewId_("input");this.container_.appendChild(this.input_);a.latestTooltip&&(b=document.createElement("span"),b.textContent=a.latestTooltip,b.classList.add("hidden"),b.id=ShakaDemoInput.generateNewId_("extra-info"),this.container_.appendChild(b),
this.input_.setAttribute("aria-describedby",b.id));this.extra_=null;d&&(this.extra_=document.createElement(d),this.container_.appendChild(this.extra_))};ShakaDemoInput.prototype.input=function(){return this.input_};ShakaDemoInput.prototype.container=function(){return this.container_};ShakaDemoInput.prototype.extra=function(){return this.extra_};ShakaDemoInput.generateNewId_=function(a){var b=ShakaDemoInput.lastId_;ShakaDemoInput.lastId_+=1;return a+"-labeled-"+b};ShakaDemoInput.lastId_=0;
var ShakaDemoSelectInput=function(a,b,c,d){ShakaDemoInput.call(this,a,"select","div","label",c);this.container_.classList.add("mdl-textfield");this.container_.classList.add("mdl-js-textfield");this.container_.classList.add("mdl-textfield--floating-label");this.input_.classList.add("mdl-textfield__input");this.extra_.classList.add("mdl-textfield__label");this.extra_.setAttribute("for",this.input_.id);a=$jscomp.makeIterator(Object.keys(d));for(b=a.next();!b.done;b=a.next())b=b.value,c=document.createElement("option"),
c.textContent=d[b],c.value=b,this.input_.appendChild(c)};$jscomp.inherits(ShakaDemoSelectInput,ShakaDemoInput);ShakaDemoSelectInput.lastId_=ShakaDemoInput.lastId_;ShakaDemoSelectInput.generateNewId_=ShakaDemoInput.generateNewId_;
var ShakaDemoBoolInput=function(a,b,c){ShakaDemoInput.call(this,a,"input","label","span",c);this.input_.type="checkbox";this.container_.classList.add("mdl-switch");this.container_.classList.add("mdl-js-switch");this.container_.classList.add("mdl-js-ripple-effect");this.container_.setAttribute("for",this.input_.id);this.input_.classList.add("mdl-switch__input");this.extra_.classList.add("mdl-switch__label")};$jscomp.inherits(ShakaDemoBoolInput,ShakaDemoInput);ShakaDemoBoolInput.lastId_=ShakaDemoInput.lastId_;
ShakaDemoBoolInput.generateNewId_=ShakaDemoInput.generateNewId_;var ShakaDemoTextInput=function(a,b,c){ShakaDemoInput.call(this,a,"input","div","label",c);this.container_.classList.add("mdl-textfield");this.container_.classList.add("mdl-js-textfield");this.container_.classList.add("mdl-textfield--floating-label");this.input_.classList.add("mdl-textfield__input");this.extra_.classList.add("mdl-textfield__label");this.extra_.setAttribute("for",this.input_.id)};$jscomp.inherits(ShakaDemoTextInput,ShakaDemoInput);
ShakaDemoTextInput.lastId_=ShakaDemoInput.lastId_;ShakaDemoTextInput.generateNewId_=ShakaDemoInput.generateNewId_;var ShakaDemoDatalistInput=function(a,b,c,d){ShakaDemoTextInput.call(this,a,b,c);var e=new Awesomplete(this.input_);e.list=d.slice();e.minChars=0;this.input_.addEventListener("focus",function(){e.evaluate()})};$jscomp.inherits(ShakaDemoDatalistInput,ShakaDemoTextInput);ShakaDemoDatalistInput.lastId_=ShakaDemoTextInput.lastId_;ShakaDemoDatalistInput.generateNewId_=ShakaDemoTextInput.generateNewId_;
var ShakaDemoNumberInput=function(a,b,c,d,e,f){ShakaDemoTextInput.call(this,a,b,c);a=document.createElement("span");a.classList.add("mdl-textfield__error");this.container_.appendChild(a);a.textContent="Must be a positive";this.input_.pattern="(Infinity|";e?this.input_.pattern+="[0-9]*":(this.input_.pattern+="[0-9]*[1-9][0-9]*",a.textContent+=", nonzero");d?(this.input_.pattern+="(.[0-9]+)?",a.textContent+=" number."):a.textContent+=" integer.";this.input_.pattern+=")";f&&(this.input_.pattern+="?")};
$jscomp.inherits(ShakaDemoNumberInput,ShakaDemoTextInput);ShakaDemoNumberInput.lastId_=ShakaDemoTextInput.lastId_;ShakaDemoNumberInput.generateNewId_=ShakaDemoTextInput.generateNewId_;var ShakaDemoInputContainer=function(a,b,c,d){this.style_=c;this.table_=document.createElement("div");this.numRows_=0;b&&this.createHeader_(a,b);this.table_.classList.add(c);c==ShakaDemoInputContainer.Style.ACCORDION&&this.table_.classList.add("hidden");a.appendChild(this.table_);d&&this.addDocLink_(this.table_,d)};ShakaDemoInputContainer.prototype.getIsOpen=function(){return this.style_==ShakaDemoInputContainer.Style.ACCORDION?this.table_.classList.contains("show"):!1};
ShakaDemoInputContainer.prototype.open=function(){var a=this;!this.style_!=ShakaDemoInputContainer.Style.ACCORDION&&(this.table_.classList.remove("hidden"),setTimeout(function(){a.table_.classList.add("show")},20),this.header_.classList.add("mdl-button--colored"))};
ShakaDemoInputContainer.prototype.close=function(){var a=this;this.style_==ShakaDemoInputContainer.Style.ACCORDION&&(this.table_.classList.remove("show"),this.table_.addEventListener("transitionend",function(b){a.table_.classList.add("hidden")},{once:!0}),this.header_.classList.remove("mdl-button--colored"))};
ShakaDemoInputContainer.prototype.createHeader_=function(a,b){var c=this;this.style_==ShakaDemoInputContainer.Style.ACCORDION?(this.header_=document.createElement("button"),this.header_.classList.add("mdl-button--raised"),this.header_.classList.add("mdl-button"),this.header_.classList.add("mdl-js-button"),this.header_.classList.add("mdl-js-ripple-effect"),this.header_.addEventListener("click",function(){c.getIsOpen()?c.close():c.open()})):this.header_=document.createElement("h3");this.header_.textContent=
b;a.appendChild(this.header_)};ShakaDemoInputContainer.prototype.addDocLink_=function(a,b){var c=document.createElement("a");c.href=b;c.target="_blank";c.classList.add("mdl-button");c.classList.add("mdl-js-button");c.classList.add("mdl-js-ripple-effect");c.classList.add("mdl-button--colored");var d=document.createElement("i");d.classList.add("material-icons");d.textContent="help";c.appendChild(d);a.appendChild(c)};
ShakaDemoInputContainer.prototype.addRow=function(a,b,c){this.latestRow_=document.createElement("div");c&&this.latestRow_.classList.add(c);this.table_.appendChild(this.latestRow_);c="input-container-row-"+this.numRows_;this.numRows_+=1;if(a){var d=document.createElement("label");d.setAttribute("for",c);d.classList.add("input-container-label");var e=document.createElement("b");e.textContent=a;d.appendChild(e);this.latestRow_.appendChild(d)}this.latestElementContainer=document.createElement("div");
this.latestRow_.appendChild(this.latestElementContainer);this.latestElementContainer.classList.add("input-container-row");this.latestElementContainer.id=c;if(this.latestTooltip=b)ShakaDemoTooltips.make(this.table_,this.latestRow_,b),this.latestRow_.setAttribute("tabindex",-1),this.latestRow_.classList.add("borderless")};ShakaDemoInputContainer.Style={VERTICAL:"input-container-style-vertical",ACCORDION:"input-container-style-accordion",FLEX:"input-container-style-flex"};var ShakaDemoMain=function(){this.selectedAsset=this.player_=this.video_=null;this.fullyLoaded_=!1;this.controls_=null;this.nativeControlsEnabled_=!1;this.uiLocale_=""};ShakaDemoMain.prototype.initCommon_=function(){var a=this;window.addEventListener("error",function(b){if(!b.message.includes("cvox.ApiImplementation"))a.onError_(b.error)});document.getElementById("error-display-close-button").addEventListener("click",function(b){return a.closeError_()});this.setUpVersionString_()};
ShakaDemoMain.prototype.initFailed=function(){this.initCommon_();this.handleError_(shaka.util.Error.Severity.CRITICAL,"Your browser is not supported!","https://github.com/google/shaka-player#platform-and-browser-support-matrix");componentHandler.upgradeDom();for(var a=[],b=$jscomp.makeIterator(document.getElementsByClassName("should-disable-on-fail")),c=b.next();!c.done;c=b.next())a.push(c.value);a.push(document.getElementsByClassName("mdl-layout__drawer-button"));a=$jscomp.makeIterator(a);for(c=
a.next();!c.done;c=a.next())c=c.value,c.tabIndex=-1,c.classList.add("disabled-by-fail")};
ShakaDemoMain.prototype.init=function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function c(){var d,e,f;return $jscomp.generator.createGenerator(c,function(c){switch(c.nextAddress){case 1:return a.initCommon_(),d=a,c.yield(shaka.Player.probeSupport(),2);case 2:d.support_=c.yieldResult;a.video_=document.getElementById("video");a.video_.poster=ShakaDemoMain.mainPoster_;if(!navigator.serviceWorker){c.jumpTo(3);break}console.debug("Registering service worker.");c.setCatchFinallyBlocks(4);
return c.yield(navigator.serviceWorker.register("service_worker.js"),6);case 6:e=c.yieldResult;console.debug("Service worker registered!",e.scope);c.leaveTryBlock(3);break;case 4:f=c.enterCatchBlock(),console.error("Service worker registration failed!",f);case 3:return a.setupPlayer_(),a.readHash_(),window.addEventListener("hashchange",function(){return a.hashChanged_()}),c.yield(a.setupStorage_(),7);case 7:a.dispatchEventWithName_("shaka-main-loaded"),componentHandler.upgradeDom(),a.fullyLoaded_=
!0,a.remakeHash(),c.jumpToEnd()}})})};
ShakaDemoMain.prototype.setupPlayer_=function(){var a=this,b=this.video_.ui;this.player_=b.getPlayer();shaka.ui.Controls.registerElement("close",new CloseButton.Factory);var c=b.getConfiguration();c.controlPanelElements.push("close");b.configure(c);this.player_.configure("manifest.dash.clockSyncUri","https://shaka-player-demo.appspot.com/time.txt");this.defaultConfig_=this.player_.getConfiguration();c=navigator.languages||["en-us"];this.player_.configure("preferredAudioLanguage",c[0]);this.player_.configure("preferredTextLanguage",
c[0]);this.uiLocale_=c[0];this.player_.addEventListener("error",function(b){return a.onErrorEvent_(b)});this.controls_=b.getControls();this.controls_.addEventListener("error",shakaDemoMain.onErrorEvent_);this.controls_.addEventListener("caststatuschanged",function(b){a.onCastStatusChange_(b.newStatus)});this.controls_.getLocalization().addEventListener(shaka.ui.Localization.UNKNOWN_LOCALES,function(b){b=$jscomp.makeIterator(b.locales);for(var c=b.next();!c.done;c=b.next())a.loadUILocale_(c.value)});
this.loadUILocale_(this.uiLocale_);this.controls_.setEnabledShakaControls(!1);this.controls_.setEnabledNativeControls(!1);var d=document.getElementById("drawer-close-button");d.addEventListener("click",function(){document.getElementById("main-layout").MaterialLayout.toggleDrawer();a.dispatchEventWithName_("shaka-main-drawer-state-change");a.hideNode_(d)});b=document.querySelector(".mdl-layout__drawer-button");goog.asserts.assert(b,"There should be a drawer button.");b.addEventListener("click",function(){a.dispatchEventWithName_("shaka-main-drawer-state-change");
a.showNode_(d)});b=document.querySelector(".mdl-layout__obfuscator");goog.asserts.assert(b,"There should be an obfuscator.");b.addEventListener("click",function(){a.dispatchEventWithName_("shaka-main-drawer-state-change");a.hideNode_(d)});this.hideNode_(d)};ShakaDemoMain.prototype.getIsDrawerOpen=function(){var a=document.querySelector(".mdl-layout__drawer");goog.asserts.assert(a,"There should be a drawer.");return a.classList.contains("is-visible")};
ShakaDemoMain.prototype.getIdentifierFromAsset_=function(a){return a.name+(a.source==shakaAssets.Source.CUSTOM?" [CUSTOM]":"")};
ShakaDemoMain.prototype.makeStorageInstance_=function(){var a=this;if(!shaka.offline.Storage.support())return null;var b=new shaka.offline.Storage;b.configure({offline:{progressCallback:function(b,d){var c=b.appMetadata.identifier;a:{for(var f=$jscomp.makeIterator(shakaAssets.testAssets),g=f.next();!g.done;g=f.next())if(g=g.value,a.getIdentifierFromAsset_(g)==c){c=g;break a}if(shakaDemoCustom)for(f=$jscomp.makeIterator(shakaDemoCustom.assets()),g=f.next();!g.done;g=f.next())if(g=g.value,a.getIdentifierFromAsset_(g)==
c){c=g;break a}c=null}c&&(c.storedProgress=d,a.dispatchEventWithName_("shaka-main-offline-progress"))}}});return b};
ShakaDemoMain.prototype.setupOfflineSupport=function(a){var b=this;goog.asserts.assert(this.initialStoredList_,"Storage must already be initialized.");for(var c=$jscomp.makeIterator(this.initialStoredList_),d=c.next();!d.done;d=c.next()){d=d.value;var e=d.appMetadata.identifier;this.getIdentifierFromAsset_(a)==e&&(a.storedContent=d)}a.storeCallback=function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function g(){var c,d,e,l;return $jscomp.generator.createGenerator(g,function(g){switch(g.nextAddress){case 1:c=
b.makeStorageInstance_();if(!c)return g["return"]();g.setCatchFinallyBlocks(2);return g.yield(b.drmConfiguration_(a,c),4);case 4:return d={identifier:b.getIdentifierFromAsset_(a),downloaded:new Date},a.storedProgress=0,b.dispatchEventWithName_("shaka-main-offline-progress"),g.yield(c.store(a.manifestUri,d),5);case 5:e=g.yieldResult;a.storedContent=e;g.leaveTryBlock(3);break;case 2:l=g.enterCatchBlock(),b.onError_(l),a.storedContent=null;case 3:c.destroy(),a.storedProgress=1,b.dispatchEventWithName_("shaka-main-offline-progress"),
...
ShakaDemoMain.prototype.setupStorage_=function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function c(){var d,e,f;return $jscomp.generator.createGenerator(c,function(c){switch(c.nextAddress){case 1:d=a.makeStorageInstance_();if(!d)return c["return"]();c.setFinallyBlock(2);e=a;return c.yield(d.list(),4);case 4:e.initialStoredList_=c.yieldResult;case 2:c.enterFinallyBlock();d.destroy();c.leaveFinallyBlock(3);break;case 3:for(var g=$jscomp.makeIterator(shakaAssets.testAssets),k=
g.next();!k.done;k=g.next())f=k.value,a.getAssetUnsupportedReason(f,!0)||a.setupOfflineSupport(f);c.jumpToEnd()}})})};ShakaDemoMain.prototype.hashChanged_=function(){this.readHash_();this.dispatchEventWithName_("shaka-main-config-change")};
ShakaDemoMain.prototype.getAssetUnsupportedReason=function(a,b){var c=this;if(a.source==shakaAssets.Source.CUSTOM)return null;if(a.disabled)return"This asset is disabled.";if(b&&!a.features.includes(shakaAssets.Feature.OFFLINE))return"This asset cannot be downloaded.";if(b&&!shaka.offline.Storage.support())return"Your browser does not support offline storage.";if(!a.drm.includes(shakaAssets.KeySystem.CLEAR)){if(!a.drm.some(function(a){return c.support_.drm[a]}))return"Your browser does not support the required key systems.";
...
d.push("video/webm");a.features.includes(shakaAssets.Feature.MP4)&&d.push("video/mp4");a.features.includes(shakaAssets.Feature.MP2TS)&&d.push("video/mp2t");return d.some(function(a){return c.support_.media[a]})?null:"Your browser does not support the required video format."};ShakaDemoMain.prototype.setNativeControlsEnabled=function(a){this.nativeControlsEnabled_=a;this.remakeHash()};ShakaDemoMain.prototype.getNativeControlsEnabled=function(){return this.nativeControlsEnabled_};
ShakaDemoMain.prototype.loadUILocale_=function(a){var b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function d(){var e,f,g,h,k;return $jscomp.generator.createGenerator(d,function(d){switch(d.nextAddress){case 1:if(!a)return d["return"]();e="../ui/locales/"+a+".json";return d.yield(fetch(e),2);case 2:return f=d.yieldResult,f.ok?d.yield(f.json(),3):(console.warn("Unable to load locale",a),d["return"]());case 3:g=d.yieldResult;h=new Map;for(var l in g)h.set(l,g[l]);k=b.controls_.getLocalization();
k.insert(a,h);d.jumpToEnd()}})})};ShakaDemoMain.prototype.setUILocale=function(a){this.uiLocale_=a;a=[a].concat(navigator.languages);this.controls_.getLocalization().changeLocale(a)};ShakaDemoMain.prototype.getUILocale=function(){return this.uiLocale_};
ShakaDemoMain.prototype.readHash_=function(){var a=this,b=this.getParams();if(this.player_){var c=this.player_.getConfiguration();ShakaDemoUtils.runThroughHashParams(function(c,d){if(c in b){var e=a.getCurrentConfigValue(d),f=b[c];"boolean"==typeof e?f="true"==f:"number"==typeof e&&(f=parseFloat(f));a.player_.configure(d,f)}},c)}"lang"in b&&(c=b.lang,this.player_.configure("preferredAudioLanguage",c),this.player_.configure("preferredTextLanguage",c),this.setUILocale(c));"uilang"in b&&this.setUILocale(b.uilang);
"noadaptation"in b&&this.player_.configure("abr.enabled",!1);"jumpLargeGaps"in b&&this.player_.configure("streaming.jumpLargeGaps",!0);c="uncompiled";"build"in b?c=b.build:"compiled"in b&&(c="compiled");for(var d={},e=$jscomp.makeIterator(["compiled","debug_compiled","uncompiled"]),f=e.next();!f.done;d={type:d.type},f=e.next())d.type=f.value,f=document.getElementById(d.type.split("_").join("-")+"-link"),c==d.type?(f.setAttribute("disabled",""),f.removeAttribute("href"),f.title="currently selected"):
(f.removeAttribute("disabled"),f.addEventListener("click",function(b){return function(){var c=location.hash.substr(1).split(";").filter(function(a){return"compiled"!=a&&"build"!=a.split("=")[0]});c.push("build="+b.type);a.setNewHashSilent_(c.join(";"));location.reload();return!1}}(d)));this.nativeControlsEnabled_="nativecontrols"in b;ShakaDemoUtils.browserSupportsUncompiledMode()||(c=document.getElementById("uncompiled-link"),c.setAttribute("disabled",""),c.removeAttribute("href"),c.title="requires a newer browser");
shaka.log&&("vv"in b?shaka.log.setLevel(shaka.log.Level.V2):"v"in b?shaka.log.setLevel(shaka.log.Level.V1):"debug"in b?shaka.log.setLevel(shaka.log.Level.DEBUG):"info"in b&&shaka.log.setLevel(shaka.log.Level.INFO))};ShakaDemoMain.prototype.getParams=function(){var a=location.search.substr(1);a=a?a.split(";"):[];var b=location.hash.substr(1);b=b?b.split(";"):[];a=a.concat(b);b={};for(var c=0;c<a.length;++c){var d=a[c].split("=");b[d[0]]=d.slice(1).join("=")}return b};
ShakaDemoMain.prototype.getValueFromGivenConfig_=function(a,b){for(var c=b,d=a;d;){var e=d.split(/\.(.+)/);if(3==e.length)d=e[1],c=c[e[0]];else return c[e[0]]}};ShakaDemoMain.prototype.getCurrentConfigValue=function(a){var b=this.player_.getConfiguration();return this.getValueFromGivenConfig_(a,b)};ShakaDemoMain.prototype.resetConfiguration=function(a){this.configure(a,void 0)};ShakaDemoMain.prototype.configure=function(a,b){this.player_.configure(a,b)};ShakaDemoMain.prototype.getConfiguration=function(){return this.player_.getConfiguration()};
ShakaDemoMain.prototype.requestCertificate_=function(a,b){return $jscomp.asyncExecutePromiseGeneratorFunction(function d(){var e,f,g;return $jscomp.generator.createGenerator(d,function(d){switch(d.nextAddress){case 1:return e=shaka.net.NetworkingEngine.RequestType.APP,f={uris:[a]},d.yield(b.request(e,f).promise,2);case 2:return g=d.yieldResult,d["return"](g.data)}})})};
ShakaDemoMain.prototype.unload=function(){this.selectedAsset=null;var a=document.getElementById("video-bar");this.hideNode_(a);this.video_.poster=ShakaDemoMain.mainPoster_;this.player_.unload();this.dispatchEventWithName_("shaka-main-selected-asset-changed")};
ShakaDemoMain.prototype.drmConfiguration_=function(a,b){var c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function e(){var f,g,h,k,m,l,q;return $jscomp.generator.createGenerator(e,function(e){switch(e.nextAddress){case 1:f=b?b.getNetworkingEngine():c.player_.getNetworkingEngine();goog.asserts.assert(f,"There should be a net engine.");a.applyFilters(f);g=a.getConfiguration();b?b.configure(g):(c.player_.resetConfiguration(),c.player_.configure(g));h=b?b.getConfiguration():c.player_.getConfiguration();
if(!a.certificateUri){for(var p=$jscomp.makeIterator(a.licenseServers.keys()),n=p.next();!n.done;n=p.next())k=n.value,h.drm.advanced[k]&&delete h.drm.advanced[k].serverCertificate;e.jumpTo(2);break}return e.yield(c.requestCertificate_(a.certificateUri,f),3);case 3:for(m=e.yieldResult,l=new Uint8Array(m),p=$jscomp.makeIterator(a.licenseServers.keys()),n=p.next();!n.done;n=p.next())q=n.value,h.drm.advanced[q]=h.drm.advanced[q]||{},h.drm.advanced[q].serverCertificate=l;case 2:b?b.configure(h):c.player_.configure("drm.advanced",
h.drm.advanced),shakaDemoMain.remakeHash(),e.jumpToEnd()}})})};
ShakaDemoMain.prototype.loadAsset=function(a){var b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function d(){var e,f,g,h;return $jscomp.generator.createGenerator(d,function(d){switch(d.nextAddress){case 1:return b.selectedAsset=a,e=document.getElementById("video-bar"),b.showNode_(e),b.closeError_(),b.video_.poster=ShakaDemoMain.mainPoster_,e.scrollIntoView({behavior:"smooth",block:"start"}),b.dispatchEventWithName_("shaka-main-selected-asset-changed"),d.yield(b.drmConfiguration_(a),2);
case 2:return b.controls_.getCastProxy().setAppData({asset:a}),f=(a.storedContent?a.storedContent.offlineUri:null)||a.manifestUri,d.setCatchFinallyBlocks(3),d.yield(b.player_.load(f),5);case 5:b.nativeControlsEnabled_?(b.controls_.setEnabledShakaControls(!1),b.controls_.setEnabledNativeControls(!0)):(b.controls_.setEnabledShakaControls(!0),b.controls_.setEnabledNativeControls(!1));b.player_.isAudioOnly()&&(b.video_.poster=ShakaDemoMain.audioOnlyPoster_);d.leaveTryBlock(0);break;case 3:h=g=d.enterCatchBlock();
if(h.code==shaka.util.Error.Code.LOAD_INTERRUPTED)console.debug("load() interrupted");else b.onError_(h);d.jumpToEnd()}})})};
ShakaDemoMain.prototype.remakeHash=function(){var a=this;if(this.fullyLoaded_){var b=[];if(this.player_){var c=this.player_.getConfiguration();ShakaDemoUtils.runThroughHashParams(function(c,d){var e=a.getCurrentConfigValue(d),f=a.getValueFromGivenConfig_(d,a.defaultConfig_),k=isNaN(e)&&isNaN(f);e==f||k||b.push(c+"="+e)},c)}this.getCurrentConfigValue("abr.enabled")||b.push("noadaptation");this.getCurrentConfigValue("streaming.jumpLargeGaps")&&b.push("jumpLargeGaps");b.push("uilang="+this.getUILocale());
c=document.getElementById("nav-button-container");c=$jscomp.makeIterator(c.childNodes);for(var d=c.next();!d.done;d=c.next())if(d=d.value,d.nodeType==Node.ELEMENT_NODE&&d.classList.contains("mdl-button--accent")){b.push("panel="+d.textContent);break}c=$jscomp.makeIterator(["compiled","debug_compiled","uncompiled"]);for(d=c.next();!d.done;d=c.next())d=d.value,document.getElementById(d.split("_").join("-")+"-link").hasAttribute("disabled")&&b.push("build="+d);this.nativeControlsEnabled_&&b.push("nativecontrols");
if(shaka.log&&shaka.log.currentLevel!=shaka.log.MAX_LOG_LEVEL)switch(shaka.log.currentLevel){case shaka.log.Level.INFO:b.push("info");break;case shaka.log.Level.DEBUG:b.push("debug");break;case shaka.log.Level.V2:b.push("vv");break;case shaka.log.Level.V1:b.push("v")}this.setNewHashSilent_(b.join(";"))}};ShakaDemoMain.prototype.setNewHashSilent_=function(a){history.replaceState(null,"",document.location.pathname+"#"+a)};ShakaDemoMain.prototype.getHamburgerMenu=function(){return document.getElementById("hamburger-menu-contents")};
ShakaDemoMain.prototype.hideNode_=function(a){a.classList.add("hidden")};ShakaDemoMain.prototype.showNode_=function(a){a.classList.remove("hidden")};
ShakaDemoMain.prototype.addNavButton=function(a){var b=this,c=document.getElementById("nav-button-container"),d=document.getElementById("contents"),e=document.getElementById("nav-button-"+a),f=this.getParams();(a=f.panel==encodeURI(e.textContent))||f.panel||(a=null!=e.getAttribute("defaultselected"));var g=document.createElement("div");this.hideNode_(g);d.appendChild(g);f=function(){for(var a=$jscomp.makeIterator(c.childNodes),f=a.next();!f.done;f=a.next())f=f.value,f.nodeType==Node.ELEMENT_NODE&&
f.classList.remove("mdl-button--accent");a=$jscomp.makeIterator(d.childNodes);for(f=a.next();!f.done;f=a.next())f=f.value,f.nodeType==Node.ELEMENT_NODE&&b.hideNode_(f);e.classList.add("mdl-button--accent");b.showNode_(g);b.remakeHash();g.scrollIntoView({behavior:"smooth",block:"start"})};e.addEventListener("click",f);a&&f();return g};ShakaDemoMain.prototype.dispatchEventWithName_=function(a){var b=document.createEvent("CustomEvent");b.initCustomEvent(a,!1,!1,null);document.dispatchEvent(b)};
ShakaDemoMain.prototype.setUpVersionString_=function(){for(var a=shaka.Player.version.split("-"),b=[],c={},d=$jscomp.makeIterator(["debug","uncompiled"]),e=d.next();!e.done;c={whitelisted:c.whitelisted},e=d.next())c.whitelisted=e.value,a.includes(c.whitelisted)&&(b.push(c.whitelisted),a=a.filter(function(a){return function(b){return b!=a.whitelisted}}(c)));c=document.getElementById("version-string");c.textContent=a.join("-");0<b.length&&(c.textContent+=" ("+b.join(", ")+")")};
ShakaDemoMain.prototype.closeError_=function(){document.getElementById("error-display").classList.add("hidden");var a=document.getElementById("error-display-link");a.href="";a.textContent="";a.severity=null};ShakaDemoMain.prototype.onErrorEvent_=function(a){this.onError_(a.detail)};
ShakaDemoMain.prototype.onError_=function(a){var b=a.severity;if(null==b||void 0==a.severity)b=shaka.util.Error.Severity.CRITICAL;var c=a.message||"Error code "+a.code,d="";a.code&&(d="../docs/api/shaka.util.Error.html#value:"+a.code);console.error(a);this.handleError_(b,c,d)};
ShakaDemoMain.prototype.handleError_=function(a,b,c){var d=document.getElementById("error-display-link");if(null==d.severity||a>d.severity)d.href=c,void 0===d.textContent?d.innerText=b:d.textContent=b,d.severity=a,d.href?d.classList.remove("input-disabled"):d.classList.add("input-disabled"),document.getElementById("error-display").classList.remove("hidden")};ShakaDemoMain.prototype.onCastStatusChange_=function(a){};var shakaDemoMain=new ShakaDemoMain;ShakaDemoMain.mainPoster_="https://shaka-player-demo.appspot.com/assets/poster.jpg";
ShakaDemoMain.audioOnlyPoster_="https://shaka-player-demo.appspot.com/assets/audioOnly.gif";ShakaDemoMain.initWrapper=function(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function c(){var d;return $jscomp.generator.createGenerator(c,function(c){switch(c.nextAddress){case 1:return c.setCatchFinallyBlocks(2),c.yield(a(),4);case 4:c.leaveTryBlock(0);break;case 2:d=c.enterCatchBlock(),shakaDemoMain.onError_(d),console.error(d),c.jumpToEnd()}})})};
document.addEventListener("shaka-ui-loaded",function(){ShakaDemoMain.initWrapper(function(){return shakaDemoMain.init()})});document.addEventListener("shaka-ui-load-failed",function(a){ShakaDemoMain.initWrapper(function(){return shakaDemoMain.initFailed()})});var shakaDemoSearch,ShakaDemoSearch=function(a){var b=this;this.desiredFeatures_=[];this.makeSearchDiv_(a);this.assetCards_=[];this.resultsDiv_=document.createElement("div");a.appendChild(this.resultsDiv_);this.remakeResultsDiv_();document.addEventListener("shaka-main-selected-asset-changed",function(){b.updateSelected_()});document.addEventListener("shaka-main-offline-progress",function(){b.updateOfflineProgress_()})};
ShakaDemoSearch.init=function(){var a=shakaDemoMain.addNavButton("search");shakaDemoSearch=new ShakaDemoSearch(a)};ShakaDemoSearch.prototype.createAssetCardFor_=function(a){var b=this;return new AssetCard(this.resultsDiv_,a,!1,function(c){var d=shakaDemoMain.getAssetUnsupportedReason(a,!1);d?c.markAsUnsupported(d):(c.addButton("Play",function(){shakaDemoMain.loadAsset(a);b.updateSelected_()}),c.addStoreButton())})};
ShakaDemoSearch.prototype.updateOfflineProgress_=function(){for(var a=$jscomp.makeIterator(this.assetCards_),b=a.next();!b.done;b=a.next())b.value.updateProgress()};ShakaDemoSearch.prototype.updateSelected_=function(){for(var a=$jscomp.makeIterator(this.assetCards_),b=a.next();!b.done;b=a.next())b.value.selectByAsset(shakaDemoMain.selectedAsset)};
ShakaDemoSearch.prototype.remakeResultsDiv_=function(){var a=this;shaka.ui.Utils.removeAllChildren(this.resultsDiv_);this.assetCards_=this.searchResults_().map(function(b){return a.createAssetCardFor_(b)});this.updateSelected_()};
ShakaDemoSearch.prototype.addDesiredTerm_=function(a,b,c){switch(b){case ShakaDemoSearch.TermType.DRM:this.desiredDRM_=a;break;case ShakaDemoSearch.TermType.SOURCE:this.desiredSource_=a;break;case ShakaDemoSearch.TermType.FEATURE:b=$jscomp.makeIterator(c);for(c=b.next();!c.done;c=b.next())c=this.desiredFeatures_.indexOf(c.value),-1!=c&&this.desiredFeatures_.splice(c,1);this.desiredFeatures_.push(a)}};
ShakaDemoSearch.prototype.removeDesiredTerm_=function(a,b){switch(b){case ShakaDemoSearch.TermType.DRM:this.desiredDRM_=null;break;case ShakaDemoSearch.TermType.SOURCE:this.desiredSource_=null;break;case ShakaDemoSearch.TermType.FEATURE:var c=this.desiredFeatures_.indexOf(a);-1!=c&&this.desiredFeatures_.splice(c,1)}};
ShakaDemoSearch.prototype.makeBooleanInput_=function(a,b,c){var d=this;a.addRow(b,null,"significant-right-padding");new ShakaDemoBoolInput(a,b,function(a){a.checked?d.addDesiredTerm_(b,c,[b]):d.removeDesiredTerm_(b,c);d.remakeResultsDiv_();componentHandler.upgradeDom()})};
ShakaDemoSearch.prototype.makeSelectInput_=function(a,b,c,d){var e=this;a.addRow(null,null);for(var f={},g=$jscomp.makeIterator(c),h=g.next();!h.done;h=g.next())if(h=h.value,"DRM"==d)for(var k in shakaAssets.KeySystem){if(shakaAssets.KeySystem[k]==h){f[h]=k.split("_").map(function(a){return a[0]+a.substr(1).toLowerCase()}).join(" ");break}}else f[h]=h;var m=f.Unspecified="Unspecified";a=new ShakaDemoSelectInput(a,b,function(a){"Unspecified"!=a.value?e.addDesiredTerm_(a.value,d,c):e.removeDesiredTerm_(m,
d);m=a.value;e.remakeResultsDiv_();componentHandler.upgradeDom()},f);a.extra().textContent=b;a.input().value="Unspecified"};
ShakaDemoSearch.prototype.makeSearchDiv_=function(a){var b=shakaAssets.Feature,c=ShakaDemoSearch.TermType.FEATURE,d=ShakaDemoSearch.TermType.DRM,e=ShakaDemoSearch.TermType.SOURCE,f=new ShakaDemoInputContainer(a,null,ShakaDemoInputContainer.Style.FLEX,null);this.makeSelectInput_(f,"Manifest",[b.DASH,b.HLS],c);this.makeSelectInput_(f,"Container",[b.MP4,b.MP2TS,b.WEBM],c);this.makeSelectInput_(f,"DRM",Object.values(shakaAssets.KeySystem),d);this.makeSelectInput_(f,"Source",Object.values(shakaAssets.Source).filter(function(a){return"Custom"!=
a}),e);a=new ShakaDemoInputContainer(a,null,ShakaDemoInputContainer.Style.FLEX,null);this.makeBooleanInput_(a,b.LIVE,c);this.makeBooleanInput_(a,b.HIGH_DEFINITION,c);this.makeBooleanInput_(a,b.XLINK,c);this.makeBooleanInput_(a,b.SUBTITLES,c);this.makeBooleanInput_(a,b.TRICK_MODE,c);this.makeBooleanInput_(a,b.SURROUND,c);this.makeBooleanInput_(a,b.OFFLINE,c);this.makeBooleanInput_(a,b.STORED,c)};
ShakaDemoSearch.prototype.searchResults_=function(){var a=this;return shakaAssets.testAssets.filter(function(b){if(b.disabled||a.desiredDRM_&&!b.drm.includes(a.desiredDRM_)||a.desiredSource_&&b.source!=a.desiredSource_)return!1;for(var c=$jscomp.makeIterator(a.desiredFeatures_),d=c.next();!d.done;d=c.next())if(d=d.value,d==shakaAssets.Feature.STORED){if(!b.isStored())return!1}else if(!b.features.includes(d))return!1;return!0})};ShakaDemoSearch.TermType={FEATURE:"Feature",DRM:"DRM",SOURCE:"Source"};
document.addEventListener("shaka-main-loaded",ShakaDemoSearch.init);var ShakaDemoTooltips=function(){};ShakaDemoTooltips.make=function(a,b,c){b.id=ShakaDemoTooltips.generateNewId_();var d=document.createElement("div");d.classList.add("mdl-tooltip");d.classList.add("mdl-tooltip--large");d.setAttribute("for",b.id);d.textContent=c;a.appendChild(d)};ShakaDemoTooltips.generateNewId_=function(){var a=ShakaDemoTooltips.lastId_;ShakaDemoTooltips.lastId_+=1;return"tooltip-labeled-"+a};ShakaDemoTooltips.lastId_=0;goog.uri={};goog.uri.utils={};goog.uri.utils.splitRe_=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#(.*))?$/;goog.uri.utils.ComponentIndex={SCHEME:1,USER_INFO:2,DOMAIN:3,PORT:4,PATH:5,QUERY_DATA:6,FRAGMENT:7};goog.uri.utils.split=function(a){return a.match(goog.uri.utils.splitRe_)};goog.Uri=function(a){var b;a instanceof goog.Uri?(this.setScheme(a.getScheme()),this.setUserInfo(a.getUserInfo()),this.setDomain(a.getDomain()),this.setPort(a.getPort()),this.setPath(a.getPath()),this.setQueryData(a.getQueryData().clone()),this.setFragment(a.getFragment())):a&&(b=goog.uri.utils.split(String(a)))?(this.setScheme(b[goog.uri.utils.ComponentIndex.SCHEME]||"",!0),this.setUserInfo(b[goog.uri.utils.ComponentIndex.USER_INFO]||"",!0),this.setDomain(b[goog.uri.utils.ComponentIndex.DOMAIN]||
